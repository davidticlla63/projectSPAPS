...
@WebServlet("/ReportOrdenExamenResultadosImag")
public class ReportOrdenExamenResultadosImag extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2030287019393947485L;
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			try {
				...
				LabOrdenImag factura = em.find(LabOrdenImag.class, new Integer(
						pIdOrden));
