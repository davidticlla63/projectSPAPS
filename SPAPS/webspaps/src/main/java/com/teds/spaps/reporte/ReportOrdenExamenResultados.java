...
@WebServlet("/ReportOrdenExamenResultados")
public class ReportOrdenExamenResultados extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2676645431470532299L;
			...
			try {
				...
				if (factura != null) {
					...
					String rutaReporte = urlPath
							+ "resources/report/laboratorio/reporteOrdenExamenResultados.jasper";
