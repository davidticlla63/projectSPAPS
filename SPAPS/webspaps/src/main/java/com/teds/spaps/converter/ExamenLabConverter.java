...
import com.teds.spaps.controller.DesgLabGrupoController;
import com.teds.spaps.model.LabExamen;

@FacesConverter("examenLabConverter")
public class ExamenLabConverter implements Converter {
	...
	public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
		if (value != null && value.trim().length() > 0) {
			try {
				 ...
				 * url.split("/");
				 */
				List<LabExamen> examenes = new ArrayList<LabExamen>();
				examenes = DesgLabGrupoController.examenes;
				LabExamen examen = getObjectFromList(examenes,
	...
	public String getAsString(FacesContext fc, UIComponent uic, Object object) {
		if (object != null) {
			return String.valueOf(((LabExamen) object).getId());
		} else {
			return null;
		}
	}
